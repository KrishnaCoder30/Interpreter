...
private:
    ...
    void addToken(const TokenType& type, const string& lexeme, const string& literal = "null") {
...
const unordered_map<char, TokenType> Scanner::singleCharTokens = {
    ...
    {'}', TokenType::RIGHT_BRACE}, {'*', TokenType::STAR},        {'.', TokenType::DOT},
    {'+', TokenType::PLUS},        {'-', TokenType::MINUS},       {',', TokenType::COMMA},
    {';', TokenType::SEMICOLON},   {'=', TokenType::EQUAL},       {'!', TokenType::BANG},
    {'<', TokenType::LESS},        {'>', TokenType::GREATER},     {'/', TokenType::SLASH},
};
...
const unordered_map<char, string> Scanner::unExpectedTokens = {
    {'%', "PERCENT"}, {'#', "HASH"},  {'@', "AT"},  {'&', "AMPERSAND"}, {'$', "DOLLAR"},
    {'~', "TILDE"},   {'^', "CARET"}, {'|', "BAR"}, {'\\', "BACKSLASH"}};
